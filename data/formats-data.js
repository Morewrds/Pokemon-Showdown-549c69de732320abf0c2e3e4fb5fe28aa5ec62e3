exports.BattleFormatsData = {
	...
	machamp: {
		randomBattleMoves: ["dynamicpunch","bulkup","icepunch","stoneedge","bulletpunch","earthquake","knockoff","fakeout"],
		randomDoubleBattleMoves: ["dynamicpunch","helpinghand","protect","icepunch","rockslide","bulletpunch","knockoff","wideguard","fakeout"],
		tier: "UU"
	},
	machampmega: {
		randomBattleMoves: ["bulkup","icepunch","stoneedge","bulletpunch","earthquake","knockoff","firepunch","thunderpunch","fakeout"],
		randomDoubleBattleMoves: ["helpinghand","protect","icepunch","rockslide","bulletpunch","knockoff","wideguard","firepunch","thunderpunch","fakeout"],
